...
# . send_to_websocket.sh '{"msgType":"loadStatus", "msgData":{"node":"piarmy01","status":"red"}}'
# . send_to_websocket.sh '{"msgType":"loadStatus", "msgData":{"node":"piarmy01","status":"yellow"}}'
# . send_to_websocket.sh '{"msgType":"loadStatus", "msgData":{"node":"piarmy01","status":"green"}}'
